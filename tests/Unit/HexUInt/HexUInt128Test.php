...
class HexUInt128Test extends TestCase
{
    ...
    public function test128To8Top()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toUInt8Top();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt128('0x' . $value)->toUInt8Top();
    ...
    public function test128To8Bottom()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toUInt8Bottom();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt128('0x' . $value)->toUInt8Bottom();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test128To16Top()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toUInt16Top();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt128('0x' . $value)->toUInt16Top();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test128To16Bottom()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toUInt16Bottom();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt128('0x' . $value)->toUInt16Bottom();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test128To32Top()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toUInt32Top();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt128('0x' . $value)->toUInt32Top();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test128To32Bottom()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toUInt32Bottom();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt128('0x' . $value)->toUInt32Bottom();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test128To64Top()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toUInt64Top();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt128('0x' . $value)->toUInt64Top();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test128To64Bottom()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toUInt64Bottom();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt128('0x' . $value)->toUInt64Bottom();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test128To256()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toUInt256();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt128('0x' . $value)->toUInt256();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function testToDecimal()
    {
        ...
        $actual = HexUInt::fromUInt128($value)->toDecimal();
        $this->assertEquals($expected, $actual);
