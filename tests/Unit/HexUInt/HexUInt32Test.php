...
class HexUInt32Test extends TestCase
{
    ...
    public function test32To8Top()
    {
        ...
        $actual = HexUInt::fromUInt32($value)->toUInt8Top();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt32('0x' . $value)->toUInt8Top();
    ...
    public function test32To8Bottom()
    {
        ...
        $actual = HexUInt::fromUInt32($value)->toUInt8Bottom();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt32('0x' . $value)->toUInt8Bottom();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test32To16Top()
    {
        ...
        $actual = HexUInt::fromUInt32($value)->toUInt16Top();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt32('0x' . $value)->toUInt16Top();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test32To16Bottom()
    {
        ...
        $actual = HexUInt::fromUInt32($value)->toUInt16Bottom();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt32('0x' . $value)->toUInt16Bottom();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test32To64()
    {
        ...
        $actual = HexUInt::fromUInt32($value)->toUInt64();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt32('0x' . $value)->toUInt64();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test32To128()
    {
        ...
        $actual = HexUInt::fromUInt32($value)->toUInt128();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt32('0x' . $value)->toUInt128();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function test32To256()
    {
        ...
        $actual = HexUInt::fromUInt32($value)->toUInt256();
        $this->assertEquals($expected, $actual);

        $actual = HexUInt::fromUInt32('0x' . $value)->toUInt256();
        $this->assertEquals('0x' . $expected, $actual);
    ...
    public function testToDecimal()
    {
        ...
        $actual = HexUInt::fromUInt32($value)->toDecimal();
        $this->assertEquals($expected, $actual);
