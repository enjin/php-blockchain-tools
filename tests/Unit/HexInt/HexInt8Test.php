...
use Enjin\BlockchainTools\HexInt;
...
class HexInt8Test extends TestCase
{
    ...
    public function test8To16()
    {
        ...
        $actual = HexInt::fromInt8($value)->toInt16();
        $this->assertEquals($expected, $actual);

        $actual = HexInt::fromInt8('0x' . $value)->toInt16();
        $this->assertEquals('0x' . $expected, $actual);

        $actual = (new HexInt8($value))->toInt16();
        $this->assertEquals($expected, $actual);
    }
    ...
    public function test8To32()
    {
        ...
        $actual = HexInt::fromInt8($value)->toInt32();
        $this->assertEquals($expected, $actual);

        $actual = HexInt::fromInt8('0x' . $value)->toInt32();
        $this->assertEquals('0x' . $expected, $actual);

        $actual = (new HexInt8($value))->toInt32();
        $this->assertEquals($expected, $actual);
    }
    ...
    public function test8To64()
    {
        ...
        $actual = HexInt::fromInt8($value)->toInt64();
        $this->assertEquals($expected, $actual);

        $actual = HexInt::fromInt8('0x' . $value)->toInt64();
        $this->assertEquals('0x' . $expected, $actual);

        $actual = (new HexInt8($value))->toInt64();
        $this->assertEquals($expected, $actual);
    }
    ...
    public function test8To128()
    {
        ...
        $actual = HexInt::fromInt8($value)->toInt128();
        $this->assertEquals($expected, $actual);

        $actual = HexInt::fromInt8('0x' . $value)->toInt128();
        $this->assertEquals('0x' . $expected, $actual);

        $actual = (new HexInt8($value))->toInt128();
        $this->assertEquals($expected, $actual);
    }
    ...
    public function test8To256()
    {
        ...
        $actual = HexInt::fromInt8($value)->toInt256();
        $this->assertEquals($expected, $actual);

        $actual = HexInt::fromInt8('0x' . $value)->toInt256();
        $this->assertEquals('0x' . $expected, $actual);

        $actual = (new HexInt8($value))->toInt256();
        $this->assertEquals($expected, $actual);
    }
    ...
    public function testToDecimal()
    {
        ...
        $actual = HexInt::fromInt8($value)->toDecimal();
        $this->assertEquals($expected, $actual);
