...
class HexUInt248 extends HexUInt
{
    ...
    {
        return $this->convertDownToTop($this->value, HexUInt224::HEX_LENGTH);
    }

    public function toHexUInt224Bottom(): string
    {
        return $this->convertDownToBottom($this->value, HexUInt224::HEX_LENGTH);
    }

    public function toHexUInt232Top(): string
    {
        return $this->convertDownToTop($this->value, HexUInt232::HEX_LENGTH);
    }

    public function toHexUInt232Bottom(): string
    {
        return $this->convertDownToBottom($this->value, HexUInt232::HEX_LENGTH);
    }

    public function toHexUInt240Top(): string
    {
        return $this->convertDownToTop($this->value, HexUInt240::HEX_LENGTH);
    }

    public function toHexUInt240Bottom(): string
    {
        return $this->convertDownToBottom($this->value, HexUInt240::HEX_LENGTH);
    }
