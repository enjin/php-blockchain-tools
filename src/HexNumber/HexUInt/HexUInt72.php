...
class HexUInt72 extends BaseHexUInt
{
    public const LENGTH = 18;
    public const HEX_MIN = '000000000000000000';
    public const HEX_MAX = 'ffffffffffffffffff';
    public const INT_MIN = '0';
    public const INT_MAX = '4722366482869645213695';
