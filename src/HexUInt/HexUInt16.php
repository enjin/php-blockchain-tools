...
class HexUInt16 extends BaseHexUInt
{
    public const LENGTH = 4;
    public const HEX_MIN = '0000';
    public const HEX_MAX = 'ffff';
    public const INT_MIN = '0';
    public const INT_MAX = '65535';
    ...
    public function toUInt24(): string
    {
        return $this->convertUpTo($this->value, HexUInt24::LENGTH);
    }
