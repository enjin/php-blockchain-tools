...
class HexUInt64 extends BaseHexUInt
{
    public const LENGTH = 16;
    public const HEX_MIN = '0000000000000000';
    public const HEX_MAX = 'ffffffffffffffff';
    public const INT_MIN = '0';
    public const INT_MAX = '18446744073709551615';
